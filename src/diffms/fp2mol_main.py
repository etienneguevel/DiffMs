...
def get_resume(cfg, model_kwargs):
    ...
    if cfg.model.type == "discrete":
        ...
        raise NotImplementedError(
            "Only discrete diffusion models are supported for FP2Mol dataset currently"
        )
    cfg = model.cfg
...
def main(cfg: DictConfig):
    ...
    from diffms.datasets import fp2mol_dataset
    ...
    if cfg.general.test_only:
        ...
        try:
            ...
            logging.info(
                "Could not change directory to resume path. Using current directory."
            )
